...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Curso\News\Model\AllnewsFactory
     */
    private $allnewsFactory;

    /**
     * @var \Curso\News\Api\AllnewsRepositoryInterface
     */
     ...
     * @param \Curso\News\Model\AllnewsFactory $allnewsFactory
     * @param \Curso\News\Api\AllnewsRepositoryInterface $allnewsRepository
     */
    public function __construct(
        Action\Context $context,
        DataPersistorInterface $dataPersistor,
        \Curso\News\Model\AllnewsFactory $allnewsFactory = null,
        \Curso\News\Api\AllnewsRepositoryInterface $allnewsRepository = null
    ) {
        $this->dataPersistor = $dataPersistor;
        $this->allnewsFactory = $allnewsFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Curso\News\Model\AllnewsFactory::class);
        $this->allnewsRepository = $allnewsRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Curso\News\Api\AllnewsRepositoryInterface::class);
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Curso\News\Model\Allnews $model */
